...
const mapDispatchToProps = dispatch => ({
  ...
  addCard: (listId, cardId, cardName) =>
    dispatch(addCard(listId, cardId, cardName)),
  ...
  editDescription: (listId, cardId, description) =>
    dispatch(editDescription(listId, cardId, description)),
  addComment: (listId, cardId, comment) =>
    dispatch(addComment(listId, cardId, comment)),
  removeComment: (listId, cardId, commentId) =>
    dispatch(removeComment(listId, cardId, commentId))
});
